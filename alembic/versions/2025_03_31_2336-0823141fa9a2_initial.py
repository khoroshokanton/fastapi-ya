...
Revision ID: 0823141fa9a2
Revises:
Create Date: 2025-03-31 23:36:34.928521
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'count_students', sa.Integer(), server_default=sa.text('0'), nullable=False
        ),
